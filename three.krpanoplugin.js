...
function krpanoplugin()
{
	...
	function load_scripts(urls, callback)
	{
		...
		if (urls.length > 0)
		{
			console.log('see1:'+urls);
			var url = resolve_url_path( urls.splice(0,1)[0] );
			console.log('see2s:'+url);
	...
	function build_scene()
	{
		...
		assign_object_properties(box, "box", {ath:+30, atv:+15, depth:2000, ondown:function(obj){ obj.properties.scale *= 1.2; }, onup:function(obj){ obj.properties.scale /= 1.2; }});
		scene.add( box );
